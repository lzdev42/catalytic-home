...
> **关于插件**
>
> 本项目提供的所有插件均为**代码模板**，仅作为开发参考与二次开发的起点，**并非开箱即用的成品插件**。
>
> - 📦 插件模板源代码托管于 SDK 仓库：**[CatalyticKit](https://github.com/lzdev42/CatalyticKit)**
> - 🔧 请根据你的实际硬件协议与业务需求，在 SDK 基础上**自行修改、编译后使用**

# Catalytic 如何使用
具体通过 6 个直观步骤，帮助你快速理解并配置软件核心逻辑。
